...
export default function SystemLogsPage() {
  ...
  return (
    <div className="max-w-[1200px] w-full flex flex-col h-[calc(100vh-120px)]">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-6 gap-4 shrink-0">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-[#FDFBF7] border border-[#e0dcd5] rounded-md text-sm font-semibold text-[#302221] hover:bg-gray-50 shadow-sm transition-colors">
      ...
      {/* Main Log Window */}
      <div className="bg-[#FDFBF7] border border-[#e0dcd5] rounded-md flex flex-col flex-1 overflow-hidden shadow-sm">
        
        {/* Table Header */}
        <div className="bg-[#F4EFEA] grid grid-cols-[140px_100px_150px_1fr] px-6 py-3 border-b border-[#e0dcd5] text-[11px] font-bold text-[#7B726B] uppercase tracking-wider shrink-0">
          <div>Timestamp</div>
          <div>Level</div>
          <div>Source</div>
        ...
        <div className="flex-1 overflow-y-auto font-mono text-[13px] text-[#555] bg-[#FDFBF7]">
          {systemLogs.map((log) => {
        ...
        {/* Status Footer */}
        <div className="bg-[#F4EFEA] border-t border-[#e0dcd5] px-6 py-2.5 flex justify-between items-center text-[10px] font-mono font-bold text-[#7B726B] tracking-wider shrink-0">
