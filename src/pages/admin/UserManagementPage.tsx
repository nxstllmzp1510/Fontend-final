    ...
    <div className="max-w-[1200px] w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2.5 bg-[#4A322F] rounded-md text-sm font-semibold text-white hover:bg-[#3a2624] transition-colors shadow-sm whitespace-nowrap">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-5 rounded-lg border border-[#e8e3dd] shadow-sm flex flex-col justify-between h-[130px]">
        ...
        <div className="bg-[#FDF9F7] p-5 rounded-lg border border-[#e8e3dd] border-l-4 border-l-[#d2b3a8] shadow-sm flex flex-col justify-between h-[130px]">
