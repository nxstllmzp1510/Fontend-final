    ...
    <div className="max-w-[1200px] w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-[#5a403e] rounded-md text-sm font-semibold text-white hover:bg-[#4a322f] shadow-sm transition-colors">
          ...
          <button
            ...
            className={`
              ...
              ${activeCategory === category 
                ? "bg-[#5a403e] text-white shadow-md" 
                : "bg-white text-[#666] border border-[#e0dcd5] hover:border-[#b8b2a8] hover:bg-gray-50"
              }
            `}
          >
            {category}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {menuItems.map((item) => (
          <div 
            key={item.id} 
            className="bg-white rounded-xl border border-[#eae6e1] overflow-hidden flex flex-col shadow-sm hover:shadow-md transition-shadow group"
          >
            {/* Card Image */}
