  ...
  return (
    <div className="max-w-[1200px] w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-8 gap-4 -mt-2">
        ...
        <div className="relative w-[320px]">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-[#F4EFEA] border-none rounded-md text-sm outline-none focus:ring-1 focus:ring-[#694b49] transition-all placeholder:text-[#999]"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg border border-[#e8e3dd] shadow-sm flex justify-between items-center">
          <div>
      ...
      {/* Table Section */}
      <div className="bg-white rounded-lg border border-[#e8e3dd] shadow-sm overflow-hidden">
        
        {/* Table Toolbar */}
        <div className="px-6 py-4 border-b border-[#e8e3dd] flex justify-between items-center bg-[#FDFBF7]">
          <h2 className="text-lg font-bold text-[#302221]">Expired / Degraded Ingredients List</h2>
          <div className="flex gap-3">
            <button className="flex items-center gap-2 px-4 py-2 bg-white border border-[#d6d0c4] rounded-md text-sm font-semibold text-[#555] hover:bg-gray-50 transition-colors">
              <Icons.Filter /> Filter
            </button>
            <button className="flex items-center gap-2 px-4 py-2 bg-[#5a403e] rounded-md text-sm font-semibold text-white hover:bg-[#4a322f] transition-colors shadow-sm">
        ...
        {/* Pagination Footer */}
        <div className="bg-[#FDFBF7] px-6 py-4 border-t border-[#e8e3dd] flex items-center justify-between">
